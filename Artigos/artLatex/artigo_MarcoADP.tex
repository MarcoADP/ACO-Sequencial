...
\section{Proposta}
  ...
  o vetor de melhor formiga de cada ciclo, pois pode acontecer a situação em que dois fluxos diferentes querem escrevem a sua melhor formiga
  ...
  e outro fluxo com melhor formiga com 32, ambos leem o valor 30 na melhor formiga, e ambos entram na condição do if, o segundo fluxo
  escreveu a sua formiga como a melhor, porém, como o primeiro fluxo já estava dentro do laço, não percebeu que o valor agora é melhor
  ...
  mutex é necessário para gerenciar o recurso compartilhado. Agora, vamos detalhar a solução construída.
